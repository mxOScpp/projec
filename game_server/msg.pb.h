...
class Position final :
 ...
 public:
  ...
  // int32 BlooValue = 5;
  void clear_bloovalue();
  int32_t bloovalue() const;
  void set_bloovalue(int32_t value);
  private:
  int32_t _internal_bloovalue() const;
  void _internal_set_bloovalue(int32_t value);
  public:
...
// int32 BlooValue = 5;
inline void Position::clear_bloovalue() {
  _impl_.bloovalue_ = 0;
}
inline int32_t Position::_internal_bloovalue() const {
  return _impl_.bloovalue_;
}
inline int32_t Position::bloovalue() const {
  // @@protoc_insertion_point(field_get:pb.Position.BlooValue)
  return _internal_bloovalue();
}
inline void Position::_internal_set_bloovalue(int32_t value) {
  
  _impl_.bloovalue_ = value;
}
inline void Position::set_bloovalue(int32_t value) {
  _internal_set_bloovalue(value);
  // @@protoc_insertion_point(field_set:pb.Position.BlooValue)
}
